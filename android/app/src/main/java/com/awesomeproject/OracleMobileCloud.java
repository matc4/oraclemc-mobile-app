...
public class OracleMobileCloud extends ReactContextBaseJavaModule {
    ...
    public OracleMobileCloud(ReactApplicationContext reactContext) {
        super(reactContext);
    }

    @Override
    public String getName() {
        return "OracleMobileCloud";
    }
    ...
    public void logout(final Callback callback) {
        try {
            ...
            auth = MobileBackendManager.getManager().getDefaultMobileBackend(getCurrentActivity()).getAuthorization();
